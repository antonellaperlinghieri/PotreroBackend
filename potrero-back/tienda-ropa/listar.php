...
<body>
    ...
    <button type = "submit" class="btn btn-danger btn-lg"><a href = "index.html">Inicio</a></button>
    <button type = "submit" class="btn btn-danger btn-lg"><a href = "listar.php">Listar ropa</a></button>
    <button type = "submit" class="btn btn-danger btn-lg" ><a href = "agregar.html">Agregar ropa</a></button>
    <h2>Lista de ropa</h2>
